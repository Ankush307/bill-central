      ...
      <div className="container mx-auto max-w-[1140px] max-xl:px-5">
        <div className="flex flex-wrap items-center justify-center w-full">
          <div className="lg:w-1/2 justify-center flex flex-col pt-[75px]">
            ...
            <p className='text-white opacity-[90%] pt-4 pb-[42px] max-w-[630px] lg:mx-0 mx-auto lg:text-start text-center'>Find and switch to the best energy, gas, and internet plans with ease. Our platform simplifies your search, letting you compare providers and make informed decisions, all in one place.</p>
            <form>
          ...
          <div className="lg:w-1/2 items-center relative justify-center flex flex-col">
            <img className='max-w-[621px] py-10 w-full lg:translate-y-[100px]' src={HeroImg} alt="hero img" />
          </div>
        </div>
      </div>
    </div>
